...
extern void vmx_set_control_params ( struct vm_info* vm );
extern void vmx_set_vm_to_mbr_start_state ( struct vm_info* vm );
extern void vmx_save_host_state ( struct vm_info* vm );

extern void vmx_asm_vmexit_handler();
extern void vmx_asm_vmentry();
